...
NCCL_NET=IB  NCCL_P2P_DISABLE=1 NCCL_SHM_DISABLE=1 NCCL_DEBUG=INFO torchrun --nproc_per_node=8 /workspace/c-val/validation-tests/single-node-allreduce.py 2>&1 | tee /data/continuous_validation/nccl/$GCRNODE/nccl-$GCRNODE-$GCRTIME/nccl-$GCRNODE-$GCRTIME.log
$GCRRESULT2=pass
