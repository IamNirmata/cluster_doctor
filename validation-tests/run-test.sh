...
nccl-test-co="/workspace/c-val/validation-tests/nccl/single-node-allreduce.py"
NCCL_NET=IB  NCCL_P2P_DISABLE=1 NCCL_SHM_DISABLE=1 NCCL_DEBUG=INFO torchrun --nproc_per_node=8 "$nccl-test-file" | tee "$nccl-log-file"
