...
- **Priority-Based vs Random Sampling**: Random sampling provides a statistical view but may miss specific nodes or duplicate effort. This framework identifies all currently free nodes and prioritizes them based on the validity of their prior test results. Nodes with stale or missing data are tested first, ensuring systematic and complete coverage of the cluster's available capacity over time.
