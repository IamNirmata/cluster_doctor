...
## Assumptions
- Random sampling (representative) is important and useful for continuous cluster health monitoring but we need to revisit nodes that have not been tested recently.
