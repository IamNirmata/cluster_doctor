...
- **Prioritized Opportunistic Sampling**: The system opportunistically validates free nodes but strictly prioritizes selection based on test history. By targeting nodes with stale or missing results first, it ensures systematic cluster coverage without dedicated downtime.
